...
import { cn } from '@/lib'
import { MyCakesEmptyState } from './MyCakes.empty'
...
export const MyCakesView = (
    props: Readonly<{
        myCakesPromise: Promise<{
            cakes: Cake[] | null
            nextOffset: number
            hasMore: boolean
        }>
    ...
    const { cakes, nextOffset, hasMore } = use(props.myCakesPromise)

    if (!cakes?.length) return <MyCakesEmptyState />
